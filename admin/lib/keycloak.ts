...
export const ADMIN_ROLES = [ROLES.NATIONAL_ADMIN, ROLES.PROVINCE_ADMIN, ROLES.DISTRICT_ADMIN]
...
// Check if user is province admin
export function isProvinceAdmin(): boolean {
  return hasRole(ROLES.PROVINCE_ADMIN)
}
